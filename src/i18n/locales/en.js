export default {
  ...
  videoToGif: {
    ...
    generateSpriteSheet: 'Generate SpriteSheet',
    generatingSpriteSheet: 'Generating SpriteSheet ({current}/{total})',
    spriteSheetColumns: 'Columns (0=horizontal strip)',
    spriteSheetPadding: 'Padding',
    spriteSheetPreview: 'SpriteSheet Preview',
    spriteSheetResultInfo: 'Size: {size}, {frames} frames, {cols}×{rows}',
